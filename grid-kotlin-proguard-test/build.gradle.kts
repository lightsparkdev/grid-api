...
dependencies {
    testImplementation(project(":grid-kotlin"))
...
val proguardJar by tasks.registering(proguard.gradle.ProGuardTask::class) {
    ...
    configuration("../grid-kotlin-core/src/main/resources/META-INF/proguard/grid-kotlin-core.pro")
}
...
val testProGuard by tasks.registering(JavaExec::class) {
    ...
    mainClass.set("com.grid.api.proguard.ProGuardCompatibilityTest")
...
val r8Jar by tasks.registering(JavaExec::class) {
    ...
    args = listOf(
        ...
        "--pg-conf", "./test.pro",
        "--pg-conf", "../grid-kotlin-core/src/main/resources/META-INF/proguard/grid-kotlin-core.pro",
