...
With {remittanceProductName}, you can send and receive low cost real-time payments to bank accounts and UMA addresses worldwide through a single, simple API. Lightspark Grid automatically routes each payment across its network of Grid switches, handling FX, blockchain settlement, and instant banking off-ramps for you.

- **Single API, global reach**: {remittanceProductName} interacts with the Money Grid to route your payments globally.
- **No crypto handling**: {remittanceProductName} converts between fiat and crypto for you on demand to simplify your implementation and minimize FX costs.
