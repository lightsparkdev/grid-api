...
- **Instant settlement**: Most transfers resolve immediately. The delayed outcomes are the exceptions: a transfer suffix `005` pends about 30 seconds before failing, a transfer suffix `006` completes and is returned about 30 seconds later, a quote suffix `003` takes about six minutes, and a quote suffix `005` completes before the payout is returned
