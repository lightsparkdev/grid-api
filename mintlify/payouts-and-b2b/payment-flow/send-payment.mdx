...
description: "Learn how to send payments between accounts in either direction, with or without currency conversion"
...
Send payments between any combination of internal and external accounts, in either direction, with automatic exchange rate handling when the currencies differ.
