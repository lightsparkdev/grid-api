...
<CardGroup cols={2}>
<Card title="Same-Currency Transfers" icon="/images/icons/arrow-left-right.svg" href="#same-currency-transfers">
  Send funds in the same currency from an internal account to an external account. Fast and straightforward.
</Card>

<Card title="Cross-Currency Transfers" icon="/images/icons/globe.svg" href="#cross-currency-transfers">
...
<Card
  ...
  href="/payouts-and-b2b/payment-flow/error-handling"
>
...
<Card
  ...
  href="/payouts-and-b2b/payment-flow/list-transactions"
>
  Query and filter transaction history
</Card>

<Card title="Reconciliation" icon="/images/icons/receipt-check.svg" href="/payouts-and-b2b/payment-flow/reconciliation">
