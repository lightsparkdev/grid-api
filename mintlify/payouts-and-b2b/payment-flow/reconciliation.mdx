...
Link Grid customers to your internal customer records with `platformCustomerId`:
...
<CardGroup cols={2}>
<Card title="Send Payments" icon="paper-plane" href="/payouts-and-b2b/payment-flow/send-payment">
