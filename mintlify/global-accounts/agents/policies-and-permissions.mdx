...
<Info>
Policy amounts are integers in the smallest unit of the relevant currency. Grid infers the currency from the account or transaction context — no currency field is needed in the policy itself. For example, `50000` in a USD context means $500.00.
</Info>
