...
1. **Obtain your Grid public key**
   - This is available in your [dashboard](https://app.lightspark.com) under Developers webhook settings.
...
| `WALLET_OPERATION.*` | Retry with exponential backoff up to 7 days with maximum interval of 30 mins | No retry on 409 (duplicate webhooks) |
