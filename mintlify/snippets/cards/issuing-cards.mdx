...
| `platformCardId` | No | Platform-specific card identifier. Grid does not yet honor a value you supply here — issuance always assigns its own. Read the identifier back from the returned `Card` and store that. |
