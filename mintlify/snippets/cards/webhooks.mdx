...
One covers the card itself; the other five cover a card transaction's
lifecycle.
...
| `CARD_TRANSACTION.DECLINED` | An authorization is declined. The payload carries `cardDeclinedReason`, and no funds were pulled. |
