...
layer. The PDFs open in Illustrator, Sketch, and Affinity as editable vectors
on a 1536 × 969 pt artboard; the SVGs import into Figma and everything else.

- Front: [PDF](/images/cards/card-design/card-template-front-1536x969.pdf) or [SVG](/images/cards/card-design/card-template-front-1536x969.svg)
- Back: [PDF](/images/cards/card-design/card-template-back-1536x969.pdf) or [SVG](/images/cards/card-design/card-template-back-1536x969.svg)
