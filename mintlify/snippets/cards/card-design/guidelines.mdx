...
lead time, and some change what the artwork can be: a bare metal face is
etched, not printed. If you are considering one, talk to your Lightspark
contact before you design. The same applies to a vertical orientation or a
custom back layout.
