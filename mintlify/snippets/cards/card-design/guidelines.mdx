...
Beyond the two standard bodies, the manufacturer offers premium options: metal
cards, colored cores and edges, a spot gloss varnish or hot-stamped foil on
the logo, an etched logo on metal, a colored magnetic stripe, and translucent
or recycled plastic. Each one raises the per-card cost, adds a minimum order,
and adds weeks to months of lead time, and metal needs Visa's approval of the
material before production.

Decide on these before you design. Foil and spot gloss take one color and a
vector logo; an etched logo has no color at all; and a colored core changes
how the edge and any unprinted area read. Tell your Lightspark contact what
you want and we scope cost and schedule with the manufacturer.
...
- Metallic and fluorescent colors do not print in CMYK. A metallic look comes from foil (see premium finishes).
...
orientation or a custom back layout, contact your Lightspark contact before
you start.
