...
## Two ways to make your card

Cards are printed on one of two bodies. Pick the one that fits your brand.

<CardSamples />

- **Monochrome**: black-core plastic. Personalization prints in white. Your logo prints in white or in one spot color (give us a Pantone number or a hex value). Finishes: matte, gloss, or satin. The card edge is black. Best for a black, white, or one-color brand, and the shorter path to printed cards.
- **Full color**: CMYK print on white-core plastic. Any color, gradient, or artwork, printed edge to edge on both faces. On the back, the stripe band bleeds to the top edge. The card edge is white. Best for brand colors, gradients, and photographic or illustrated artwork.
...
- **Artwork**: photographs, gradients, and patterns are fine on the full-color body. Supply vector artwork where you can. Raster artwork must be at least 1536 × 969 px at card size; larger is better.
...
| --- | --- | --- |
| Magnetic stripe | Standard black band. On the full-color body it extends to the top edge. | Fixed |
...
| Visa DEBIT lockup | Silver foil, with 3 mm clear space on every side kept free of text and logos. | Fixed |
