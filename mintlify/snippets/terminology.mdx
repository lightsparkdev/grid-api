...
- Customers can have multiple external accounts (bank accounts or crypto wallets)
- The platform has its own internal accounts separate from customers
- Quotes define the parameters for creating transactions, and lock in an exchange rate for a short period of time
