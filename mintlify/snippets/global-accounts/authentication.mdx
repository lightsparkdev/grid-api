...
| `FAILED` | Same path, but applying it didn't work. `failureReason` says why; the contact is unchanged. | Show the reason and create a new change. Don't retry this one — it's terminal. |
