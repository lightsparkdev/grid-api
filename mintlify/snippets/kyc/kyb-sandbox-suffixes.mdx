...
Business customers never resolve at creation — the outcome lands on the first `POST /verifications`. What happens on that submission depends on your platform:
