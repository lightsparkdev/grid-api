...
Optional URI parameter that specifies where the customer will be automatically redirected after successfully completing the hosted KYC verification process.
</ParamField>
