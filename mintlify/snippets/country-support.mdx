...
<FeatureCardGrid cols={3}>
  <FeatureCard icon="/images/icons/coins.svg" title="Cryptocurrency">
    **Available Globally**
Bitcoin (BTC) and Stablecoin transactions supported worldwide with no geographic restrictions.
  </FeatureCard>
  <FeatureCard icon="/images/icons/blocks.svg" title="Full Platform Access">
...
Send payments to 65 countries on local banking rails, in addition to BTC and stablecoins.
  ...
  <FeatureCard icon="/images/icons/globe.svg" title="Local Payment Rails">
    **65 Countries**
...
<FeatureCardGrid cols={4}>
  <FeatureCard icon="/images/icons/globe.svg" title="Europe">
    **32 countries** Primary: SEPA/SEPA Instant
  </FeatureCard>
  <FeatureCard icon="/images/icons/globe.svg" title="Africa">
    **17 countries** Primary: Bank Transfer
  </FeatureCard>
  <FeatureCard icon="/images/icons/globe.svg" title="Asia-Pacific">
    **11 countries** Various instant payment systems
  </FeatureCard>
  <FeatureCard icon="/images/icons/globe.svg" title="Americas">
