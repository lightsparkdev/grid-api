<CardGroup cols={3}>
  <Card title="Cryptocurrency" icon="/images/icons/coins.svg">
    **Available Globally**
Bitcoin (BTC) and Stablecoin transactions supported worldwide with no geographic restrictions.
  </Card>
  <Card title="Full Platform Access" icon="/images/icons/blocks.svg">
...
Send payments to 65 countries on local banking rails, in addition to BTC and stablecoins.
  ...
  <Card title="Local Payment Rails" icon="/images/icons/globe.svg">
    **65 Countries**
...
Regional Summary
<CardGroup cols={4}>
  <Card title="Europe" icon="/images/icons/globe.svg">
    **32 countries** Primary: SEPA/SEPA Instant
  </Card>
  <Card title="Africa" icon="/images/icons/globe.svg">
    **17 countries** Primary: Bank Transfer
  </Card>
  <Card title="Asia-Pacific" icon="/images/icons/globe.svg">
    **11 countries** Various instant payment systems
  </Card>
  <Card title="Americas" icon="/images/icons/globe.svg">
