...
<FeatureCardContainer>
  <FeatureCardList>
    ...
    <FeatureCard icon="/images/icons/blocks.svg" title="Full Platform Access" tag="United States & Europe" tagPosition="inline" layout="horizontal" variant="flat">
      ...
      Send payments to 63 countries on local banking rails, in addition to BTC and stablecoins.
    </FeatureCard>
    <FeatureCard icon="/images/icons/globe.svg" title="Local Payment Rails" tag="63 Countries" tagPosition="inline" layout="horizontal" variant="flat">
...
<FeatureCardGrid cols={4}>
  ...
  <FeatureCard icon="/images/icons/globe.svg" title="Middle East and Africa" tag="16 countries">
