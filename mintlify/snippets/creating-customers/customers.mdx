...
1. Request a hosted KYC link for a customer using your `platformCustomerId` (optional `redirectUri` to return the customer to your app when finished):
...
3. After the customer is redirected back to your app, they can continue with account setup until KYC review is complete.  
