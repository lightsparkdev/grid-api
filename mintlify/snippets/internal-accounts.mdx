...
<Warning>
  ...
  until you record their End User Terms acceptance in `agreementConsents`, and
...
<AccordionGroup>
  ...
  <Accordion title="EUR account funding (SEPA)">
    A `EUR_ACCOUNT` returns an IBAN, and deposits reach it over SEPA:
