...
2. Generate a TEK key pair and HPKE-encrypt `{otp_code: "000000", public_key: tekPublicKeyHex}`, where `tekPublicKeyHex` is the compressed public key (66 hex characters, `02` or `03` prefix)
