...
Always authorize the payload **byte-for-byte as returned**. Do not re-parse, re-serialize, trim, or normalize whitespace.

There are two authorization shapes:
