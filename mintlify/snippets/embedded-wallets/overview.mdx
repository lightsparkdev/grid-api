...
<Warning>
  Customers who hold an Embedded Wallet must be KYC/KYB verified before any funds can move in or out. This quickstart picks up after KYC is complete.
...
<Steps>
  ...
  <Step title="Your backend verifies the assertion to mint a session">
    ```bash
