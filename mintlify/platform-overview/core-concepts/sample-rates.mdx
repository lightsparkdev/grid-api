        ...
        {liveRates === null ? (
          <div>
            {Array(40).fill(0).map((_, i) => (
              <div key={i} className="rate-explorer-skeleton-row">
                <div className="rate-explorer-skeleton-flag" />
                <div className="rate-explorer-skeleton-cell" style={{width: 80}} />
                <div style={{flex: 1}} />
                <div className="rate-explorer-skeleton-cell" style={{width: 56}} />
                <div className="rate-explorer-skeleton-cell" style={{width: 56}} />
              </div>
            ))}
          </div>) : (
          ...
          <table className="rate-explorer-table">
            <thead>
              <tr>
                ...
                <th className="rate-explorer-th-grid"><span className="rate-explorer-grid-icon" />Grid</th>
                <th>Wise</th>
