...
<FeatureCardGrid cols={3}>
  <ImageCard title="BTC cashback" img="/images/use-cases/rewards-cashback.jpg" href="/rewards/index">
    Give users Bitcoin back on purchases or actions
  </ImageCard>
  <ImageCard title="Referral incentives" img="/images/use-cases/rewards-refer.jpg" href="/rewards/index">
    Pay out BTC or fiat when users refer new customers
  </ImageCard>
  <ImageCard title="Loyalty programs" img="/images/use-cases/rewards-redeem.jpg" href="/rewards/index">
