...
<Card title="Platform Configuration" icon="/images/icons/settings-gear2.svg" href="/global-p2p/getting-started/platform-configuration">
...
<Card title="UMA Test Wallet" icon="/images/icons/wallet1.svg" href="/global-p2p/platform-tools/uma-test-wallet">
...
<CardGroup cols={2}>
  <Card title="Full P2P Guide" icon="/images/icons/file-text.svg" href="/global-p2p">
    Explore the complete Global P2P documentation
  </Card>
  <Card title="Receiving Payments" icon="/images/icons/arrow-inbox.svg" href="/global-p2p/sending-receiving-payments/receiving-payments">
