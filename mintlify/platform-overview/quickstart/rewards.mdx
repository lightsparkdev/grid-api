...
<Card title="Platform Configuration" icon="gear" href="/rewards/developer-guides/platform-configuration">
...
<CardGroup cols={2}>
  <Card title="Cashback Programs" icon="percent" href="/rewards/developer-guides/distributing-rewards">
    Instant Bitcoin cashback on purchases
  </Card>
  <Card title="Loyalty Rewards" icon="star" href="/rewards/developer-guides/distributing-rewards">
...
<CardGroup cols={2}>
  <Card title="Full Rewards Guide" icon="book" href="/rewards">
    Explore the complete Rewards documentation
  </Card>
  <Card title="Webhooks" icon="webhook" href="/rewards/platform-tools/webhooks">
