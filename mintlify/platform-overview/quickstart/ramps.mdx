...
<Card title="Platform Configuration" icon="/images/icons/settings-gear2.svg" href="/ramps/onboarding/platform-configuration">
...
<CardGroup cols={2}>
  <Card title="Plaid Integration" icon="/images/icons/IconPlaid.svg" href="/ramps/accounts/plaid">
    Link bank accounts via Plaid
  </Card>
  <Card title="External Accounts" icon="/images/icons/bank.svg" href="/ramps/accounts/external-accounts">
...
<CardGroup cols={2}>
  <Card title="Full Ramps Guide" icon="/images/icons/file-text.svg" href="/ramps">
    Explore the complete Ramps documentation
  </Card>
  <Card title="Self-Custody Wallets" icon="/images/icons/key2.svg" href="/ramps/conversion-flows/self-custody-wallets">
