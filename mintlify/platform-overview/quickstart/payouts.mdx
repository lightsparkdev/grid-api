...
<Card title="Platform Configuration" icon="gear" href="/payouts-and-b2b/onboarding/platform-configuration">
...
<CardGroup cols={2}>
  <Card title="Internal Accounts" icon="wallet" href="/payouts-and-b2b/depositing-funds/internal-accounts">
    Platform-managed accounts for holding funds
  </Card>
  <Card title="External Accounts" icon="bank" href="/payouts-and-b2b/depositing-funds/external-accounts">
...
<CardGroup cols={2}>
  <Card title="Full Payouts Guide" icon="book" href="/payouts-and-b2b">
