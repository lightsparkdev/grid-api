...
import { FeatureCard, FeatureCardGrid, FeatureCardList } from '/snippets/feature-card.mdx';
...
<FeatureCardList>
  <FeatureCard icon="/images/icons/code.svg" title="One API" layout="horizontal">
    Move money anywhere. Fiat to fiat, crypto to fiat, or the other way around, all through a single API.
  </FeatureCard>
  <FeatureCard icon="/images/icons/globe.svg" title="Global Coverage" layout="horizontal">
    Send and receive across 65+ countries using local instant rails or global crypto rails.
  </FeatureCard>
  <FeatureCard icon="/images/icons/lightning.svg" title="Real-Time Settlement" layout="horizontal">
    Instant, 24/7/365. Powered by Bitcoin and local payment networks.
  </FeatureCard>
  <FeatureCard icon="/images/icons/shield.svg" title="No Crypto Headaches" layout="horizontal">
