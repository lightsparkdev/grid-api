...
<Tabs>
  ...
  <Tab title="Stablecoin Payments">
    ...
    - **Orchestration**: Convert liquidity between stablecoins and fiat automatically.
    - **Treasury**: Hold business reserves in stablecoins with instant conversion to local currency when needed.
  </Tab>

  <Tab title="Bitcoin Payments">
    - **Buy & Sell Bitcoin**: Enable users to buy or sell Bitcoin instantly inside your app.
    - **Rewards**: Offer instant Bitcoin cashback for actions or purchases.
