...
<Note>
In sandbox, you can use special account number patterns to test different scenarios. The **last 3 digits** determine the behavior: **002** (insufficient funds), **003** (account closed), **004** (transfer rejected), **005** (timeout/delayed failure), **006** (late return — settles, then is returned). Any other ending succeeds normally. See "Testing transfer failures" below for details.
</Note>
