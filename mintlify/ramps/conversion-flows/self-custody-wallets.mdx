...
<CardGroup cols={2}>
<Card title="Fiat-crypto conversion" icon="arrow-right-arrow-left" href="/ramps/conversion-flows/fiat-crypto-conversion">
...
<Card title="Sandbox testing" icon="flask" href="/ramps/platform-tools/sandbox-testing">
