...
<CardGroup cols={2}>
<Card title="Fiat-crypto conversion" icon="/images/icons/arrow-left-right.svg" href="/ramps/conversion-flows/fiat-crypto-conversion">
...
<Card
  ...
  href="/ramps/platform-tools/webhooks"
>
  Set up webhooks to monitor transaction status
</Card>

<Card title="Sandbox testing" icon="/images/icons/sandbox.svg" href="/ramps/platform-tools/sandbox-testing">
