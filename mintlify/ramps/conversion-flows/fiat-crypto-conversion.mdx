...
<CardGroup cols={2}>
<Card title="Self-custody wallets" icon="/images/icons/wallet1.svg" href="/ramps/conversion-flows/self-custody-wallets">
  Send crypto to user-controlled wallets
</Card>

<Card title="Webhooks" icon="/images/icons/bell.svg" href="/ramps/platform-tools/webhooks">
