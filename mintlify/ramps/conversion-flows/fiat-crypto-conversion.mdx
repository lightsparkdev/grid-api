...
function displayPaymentInstructions(quote) {
  ...
  return {
    ...
    bankName: instructions.accountInfo.bankName,
    accountNumber: instructions.accountInfo.accountNumber,
    routingNumber: instructions.accountInfo.routingNumber,
...
<CardGroup cols={2}>
<Card title="Self-custody wallets" icon="wallet" href="/ramps/conversion-flows/self-custody-wallets">
  Send crypto to user-controlled wallets
</Card>

<Card title="Webhooks" icon="webhook" href="/ramps/platform-tools/webhooks">
