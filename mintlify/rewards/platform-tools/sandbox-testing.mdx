...
- **002**: Insufficient funds (pulling from the account will fail)
...
- **Simplified KYB**: KYB processes are simulated rather than reviewed for real, resolving at the first `POST /verifications` submission
