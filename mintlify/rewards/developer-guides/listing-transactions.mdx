...
<CardGroup cols={2}>
<Card title="Distributing Rewards" icon="/images/icons/gift1.svg" href="/rewards/developer-guides/distributing-rewards">
...
<Card title="API Reference" icon="/images/icons/code.svg" href="/api-reference/transactions/list-transactions">
