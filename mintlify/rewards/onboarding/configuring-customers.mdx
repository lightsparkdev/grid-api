...
import EndUserTermsConsent from '/snippets/creating-customers/end-user-terms-consent.mdx'
...
<Info>
When a customer is created successfully, internal accounts are automatically created for each currency configured on your platform. These accounts can be used as sources or destinations for transfers. On unregulated platforms, provisioning waits until the customer's End User Terms acceptance is recorded.
</Info>
