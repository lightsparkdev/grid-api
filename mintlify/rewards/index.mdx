...
<img 
  src="https://placehold.co/928x400/e8e8e8/666666?text=Hero+Image" 
...
<CardGroup cols={3}>
  <Card title="Buy & Send in One Call" icon="/images/icons/lightning.svg">
  ...
  <Card title="No Crypto Handling" icon="/images/icons/shield.svg">
  ...
  <Card title="Instant Delivery" icon="/images/icons/paper-plane-top-right.svg">
...
<Card title="Get Started" icon="/images/icons/light-bulb.svg" href="/rewards/quickstart">
