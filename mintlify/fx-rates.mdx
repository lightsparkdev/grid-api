    ...
    <div ref={containerRef}>
      <div ref={explorerRef} className="rate-explorer not-prose">
        <div className="rate-explorer-disclaimer">
          Grid offers real-time settlement, no float requirements, and global reach via a single API. Competitor rates are sourced from live public comparison data and published pricing schedules. Standard Grid rates shown. Actual rates may vary. <a href="/platform-overview/core-concepts/quote-system">Get a real-time quote</a> or <a href="https://www.lightspark.com/contact">contact sales</a> for volume pricing.
        </div>
