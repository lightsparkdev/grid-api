...
export const CURRENCIES = [
  ...
  { code: 'CRC', name: 'Costa Rican Colon', region: 'Americas', usdMid: 512, rateCardSpread: 0.80, wiseSpread: 1.60 },
  ...
  { code: 'PHP', name: 'Philippine Peso', region: 'Asia-Pacific', usdMid: 56.2, rateCardSpread: 0.34, wiseSpread: 1.00 },
  ...
  { code: 'VND', name: 'Vietnamese Dong', region: 'Asia-Pacific', usdMid: 25200, rateCardSpread: 0.80, wiseSpread: 1.10 },
  { code: 'MYR', name: 'Malaysian Ringgit', region: 'Asia-Pacific', usdMid: 4.65, rateCardSpread: 0.31, wiseSpread: 1.00 },
  { code: 'LKR', name: 'Sri Lankan Rupee', region: 'Asia-Pacific', usdMid: 298, rateCardSpread: 0.34, wiseSpread: 1.80 },
];
...
export const RateExplorer = () => {
  ...
  const allCorridors = destinations.map(dest => {
    ...
    const GRID_MARGIN = 0.30;
    const hasCostData = gridCostRates && gridCostRates[dest.code] !== undefined;
    var fallbackSpread = 0.93;
    if (['CAD','CHF','HKD'].includes(dest.code)) fallbackSpread = 0.86;
    else if (['ISK','GHS','CDF','LKR','CRC'].includes(dest.code)) fallbackSpread = 1.21;
    const effectiveSpread = hasCostData ? Math.max(costFloorSpread + GRID_MARGIN, rateCard) : fallbackSpread;
    ...
    <div ref={containerRef}>
      <div ref={explorerRef} className="rate-explorer not-prose">
        <div className="rate-explorer-disclaimer">
          Standard rates shown. Grid offers real-time settlement, no float requirements, and global reach via a single API. Competitor rates are sourced from live public comparison data and published pricing schedules. Actual rates may vary — <a href="/platform-overview/core-concepts/quote-system">get a real-time quote</a> or <a href="https://www.lightspark.com/contact">contact sales</a> for volume pricing.
        </div>
...
<div className="not-prose">
  <a href="https://www.lightspark.com/contact" className="fx-rates-pricing-banner">
    <div className="fx-rates-pricing-banner-bg"></div>
    <div className="fx-rates-pricing-banner-content">
      <div className="fx-rates-pricing-banner-text">
        <span>Get custom pricing</span>
        <span className="fx-rates-pricing-banner-subtext">Standard rates shown</span>
      </div>
      <span className="fx-rates-pricing-banner-button">Contact sales</span>
    </div>
  </a>
</div>
