...
package com.grid.api.client.okhttp

import com.fasterxml.jackson.databind.json.JsonMapper
import com.grid.api.client.GridClient
import com.grid.api.client.GridClientImpl
import com.grid.api.core.ClientOptions
import com.grid.api.core.Sleeper
import com.grid.api.core.Timeout
import com.grid.api.core.http.Headers
import com.grid.api.core.http.HttpClient
...
/**
 * A class that allows building an instance of [GridClient] with [OkHttpClient] as the underlying
 * [HttpClient].
 */
class GridOkHttpClient private constructor() {

    companion object {

        /** Returns a mutable builder for constructing an instance of [GridClient]. */
        fun builder() = Builder()
         ...
         */
        fun fromEnv(): GridClient = builder().fromEnv().build()
    }

    /** A builder for [GridOkHttpClient]. */
    class Builder internal constructor() {
         ...
         *
         * Defaults to [com.grid.api.core.jsonMapper]. The default is usually sufficient and rarely
        ...
        /**
         * Returns an immutable instance of [GridClient].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): GridClient =
            GridClientImpl(
                clientOptions
                    .httpClient(
