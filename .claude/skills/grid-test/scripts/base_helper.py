#!/usr/bin/env python3
"""Base chain CLI for Grid USDC testing.

Supports both Base Sepolia testnet (default) and Base mainnet (--mainnet flag).
...
NETWORKS = {
    "testnet": {
        ...
        "cred_key": "baseTestnetPrivateKey",
        "name": "Base Sepolia",
    ...
    "mainnet": {
        ...
        "cred_key": "baseMainnetPrivateKey",
        "name": "Base Mainnet",
...
def main():
    ...
    parser = argparse.ArgumentParser(description="Base chain helper for Grid USDC testing")
    parser.add_argument("--mainnet", action="store_true", help="Use Base mainnet instead of Sepolia testnet")
