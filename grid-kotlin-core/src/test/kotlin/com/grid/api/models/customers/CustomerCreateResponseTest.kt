...
internal class CustomerCreateResponseTest {
    ...
    fun ofIndividualCustomer() {
        ...
        val customerCreateResponse = CustomerCreateResponse.ofIndividualCustomer(individualCustomer)

        assertThat(customerCreateResponse.individualCustomer()).isEqualTo(individualCustomer)
        assertThat(customerCreateResponse.businessCustomer()).isNull()
    }
    ...
    fun ofBusinessCustomer() {
        ...
        val customerCreateResponse = CustomerCreateResponse.ofBusinessCustomer(businessCustomer)

        assertThat(customerCreateResponse.individualCustomer()).isNull()
        assertThat(customerCreateResponse.businessCustomer()).isEqualTo(businessCustomer)
    }
    ...
    fun ofBusinessCustomerRoundtrip() {
        val jsonMapper = jsonMapper()
        val customerCreateResponse =
            CustomerCreateResponse.ofBusinessCustomer(
                BusinessCustomer.builder()
                    .customerType(CustomerType.INDIVIDUAL)
                    .platformCustomerId("9f84e0c2a72c4fa")
                    .umaAddress("\$john.doe@uma.domain.com")
    ...
    fun incompatibleJsonShapeDeserializesToUnknown(testCase: IncompatibleJsonShapeTestCase) {
        val customerCreateResponse =
            jsonMapper().convertValue(testCase.value, jacksonTypeRef<CustomerCreateResponse>())

        val e = assertThrows<GridInvalidDataException> { customerCreateResponse.validate() }
