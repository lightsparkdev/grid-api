...
-keep @com.fasterxml.jackson.databind.annotation.JsonSerialize class com.grid.api.** { *; }
-keep @com.fasterxml.jackson.databind.annotation.JsonDeserialize class com.grid.api.** { *; }

# Jackson uses reflection to serialize and deserialize our classes based on their constructors and annotated members.
-keepclassmembers class com.grid.api.** {
    <init>(...);
