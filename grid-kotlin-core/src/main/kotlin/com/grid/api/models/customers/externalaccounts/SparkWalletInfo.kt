...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [SparkWalletInfo].
         *
    ...
    class Builder internal constructor() {
        ...
        internal fun from(sparkWalletInfo: SparkWalletInfo) = apply {
            accountType = sparkWalletInfo.accountType
            address = sparkWalletInfo.address
            additionalProperties = sparkWalletInfo.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [SparkWalletInfo].
         *
    ...
    fun validate(): SparkWalletInfo = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is SparkWalletInfo &&
    ...
    override fun toString() =
        "SparkWalletInfo{accountType=$accountType, address=$address, additionalProperties=$additionalProperties}"
}
