...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [BaseWalletInfo].
         *
    ...
    class Builder internal constructor() {
        ...
        internal fun from(baseWalletInfo: BaseWalletInfo) = apply {
            accountType = baseWalletInfo.accountType
            address = baseWalletInfo.address
            additionalProperties = baseWalletInfo.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [BaseWalletInfo].
         *
    ...
    fun validate(): BaseWalletInfo = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BaseWalletInfo &&
    ...
    override fun toString() =
        "BaseWalletInfo{accountType=$accountType, address=$address, additionalProperties=$additionalProperties}"
}
