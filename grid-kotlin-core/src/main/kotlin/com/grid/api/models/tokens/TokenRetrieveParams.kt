...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(tokenRetrieveParams: TokenRetrieveParams) = apply {
            tokenId = tokenRetrieveParams.tokenId
        ...
        fun build(): TokenRetrieveParams =
            TokenRetrieveParams(tokenId, additionalHeaders.build(), additionalQueryParams.build())
    }
    ...
    override fun hashCode(): Int = Objects.hash(tokenId, additionalHeaders, additionalQueryParams)

    override fun toString() =
        "TokenRetrieveParams{tokenId=$tokenId, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
