...
private constructor(
    ...
    companion object {
        ...
        fun ofIndividual(individual: Individual) = CustomerUpdateResponse(individual = individual)

        fun ofBusiness(business: Business) = CustomerUpdateResponse(business = business)
    }
    ...
    interface Visitor<out T> {
        ...
        fun unknown(json: JsonValue?): T {
            throw GridInvalidDataException("Unknown CustomerUpdateResponse: $json")
        }
    }
    ...
    internal class Deserializer :
        ...
        override fun ObjectCodec.deserialize(node: JsonNode): CustomerUpdateResponse {
            ...
            return when (bestMatches.size) {
                ...
                0 -> CustomerUpdateResponse(_json = json)
