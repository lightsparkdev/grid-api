...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [TokenListPageResponse].
         *
    ...
    /** A builder for [TokenListPageResponse]. */
    class Builder internal constructor() {
        ...
        internal fun from(tokenListPageResponse: TokenListPageResponse) = apply {
            data = tokenListPageResponse.data.map { it.toMutableList() }
            hasMore = tokenListPageResponse.hasMore
            nextCursor = tokenListPageResponse.nextCursor
            totalCount = tokenListPageResponse.totalCount
            additionalProperties = tokenListPageResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [TokenListPageResponse].
         *
         ...
         */
        fun build(): TokenListPageResponse =
            TokenListPageResponse(
    ...
    fun validate(): TokenListPageResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is TokenListPageResponse &&
            data == other.data &&
    ...
    override fun toString() =
        "TokenListPageResponse{data=$data, hasMore=$hasMore, nextCursor=$nextCursor, totalCount=$totalCount, additionalProperties=$additionalProperties}"
}
