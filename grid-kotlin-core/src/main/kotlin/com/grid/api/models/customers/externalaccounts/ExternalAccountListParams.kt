 ...
 * accounts (paginated).
 *
 * External accounts are bank accounts, cryptocurrency wallets, or other payment destinations that
 * customers can use to receive funds from the platform.
 */
...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(externalAccountListParams: ExternalAccountListParams) = apply {
            ...
            customerId = externalAccountListParams.customerId
    ...
    override fun toString() =
        "ExternalAccountListParams{currency=$currency, cursor=$cursor, customerId=$customerId, limit=$limit, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
