...
private constructor(
    ...
    companion object {
        ...
        fun none(): InvitationCancelParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [InvitationCancelParams]. */
        fun builder() = Builder()
    }

    /** A builder for [InvitationCancelParams]. */
    class Builder internal constructor() {
        ...
        internal fun from(invitationCancelParams: InvitationCancelParams) = apply {
            invitationCode = invitationCancelParams.invitationCode
            additionalHeaders = invitationCancelParams.additionalHeaders.toBuilder()
            additionalQueryParams = invitationCancelParams.additionalQueryParams.toBuilder()
            additionalBodyProperties =
                invitationCancelParams.additionalBodyProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [InvitationCancelParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): InvitationCancelParams =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is InvitationCancelParams &&
    ...
    override fun toString() =
        "InvitationCancelParams{invitationCode=$invitationCode, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams, additionalBodyProperties=$additionalBodyProperties}"
}
