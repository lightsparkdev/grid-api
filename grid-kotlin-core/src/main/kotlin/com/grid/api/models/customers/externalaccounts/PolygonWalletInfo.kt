...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [PolygonWalletInfo].
         *
    ...
    /** A builder for [PolygonWalletInfo]. */
    class Builder internal constructor() {
        ...
        internal fun from(polygonWalletInfo: PolygonWalletInfo) = apply {
            accountType = polygonWalletInfo.accountType
            address = polygonWalletInfo.address
            additionalProperties = polygonWalletInfo.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [PolygonWalletInfo].
         *
    ...
    fun validate(): PolygonWalletInfo = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is PolygonWalletInfo &&
    ...
    override fun toString() =
        "PolygonWalletInfo{accountType=$accountType, address=$address, additionalProperties=$additionalProperties}"
}
