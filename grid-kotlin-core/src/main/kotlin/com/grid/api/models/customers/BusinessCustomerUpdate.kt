...
private constructor(
    ...
    ) : this(customerType, address, beneficialOwners, businessInfo, umaAddress, mutableMapOf())
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [BusinessCustomerUpdate].
         *
    ...
    /** A builder for [BusinessCustomerUpdate]. */
    class Builder internal constructor() {
        ...
        internal fun from(businessCustomerUpdate: BusinessCustomerUpdate) = apply {
            customerType = businessCustomerUpdate.customerType
            address = businessCustomerUpdate.address
            beneficialOwners = businessCustomerUpdate.beneficialOwners.map { it.toMutableList() }
            businessInfo = businessCustomerUpdate.businessInfo
            umaAddress = businessCustomerUpdate.umaAddress
            additionalProperties = businessCustomerUpdate.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [BusinessCustomerUpdate].
         *
         ...
         */
        fun build(): BusinessCustomerUpdate =
    ...
    fun validate(): BusinessCustomerUpdate = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BusinessCustomerUpdate &&
    ...
    override fun toString() =
        "BusinessCustomerUpdate{customerType=$customerType, address=$address, beneficialOwners=$beneficialOwners, businessInfo=$businessInfo, umaAddress=$umaAddress, additionalProperties=$additionalProperties}"
}
