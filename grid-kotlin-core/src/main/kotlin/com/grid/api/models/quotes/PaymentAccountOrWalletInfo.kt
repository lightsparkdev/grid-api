...
class PaymentAccountOrWalletInfo
...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [PaymentAccountOrWalletInfo].
         *
    ...
    /** A builder for [PaymentAccountOrWalletInfo]. */
    class Builder internal constructor() {

        private var accountType: JsonField<AccountType>? = null
        private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

        internal fun from(paymentAccountOrWalletInfo: PaymentAccountOrWalletInfo) = apply {
            accountType = paymentAccountOrWalletInfo.accountType
            additionalProperties = paymentAccountOrWalletInfo.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [PaymentAccountOrWalletInfo].
         *
         ...
         */
        fun build(): PaymentAccountOrWalletInfo =
    ...
    fun validate(): PaymentAccountOrWalletInfo = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is PaymentAccountOrWalletInfo &&
    ...
    override fun toString() =
        "PaymentAccountOrWalletInfo{accountType=$accountType, additionalProperties=$additionalProperties}"
}
