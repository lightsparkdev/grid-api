...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(transferOutCreateParams: TransferOutCreateParams) = apply {
            ...
            body = transferOutCreateParams.body.toBuilder()
    ...
    override fun toString() =
        "TransferOutCreateParams{idempotencyKey=$idempotencyKey, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
