...
private constructor(
    ...
    ) : this(address, beneficialOwners, businessInfo, customerType, mutableMapOf())
    ...
    private val hashCode: Int by lazy {
        Objects.hash(address, beneficialOwners, businessInfo, customerType, additionalProperties)
    }

    override fun hashCode(): Int = hashCode

    override fun toString() =
        "BusinessCustomerFields{address=$address, beneficialOwners=$beneficialOwners, businessInfo=$businessInfo, customerType=$customerType, additionalProperties=$additionalProperties}"
}
