...
package com.grid.api.models.plaid
 ...
 */
class PlaidCreateLinkTokenParams
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [PlaidCreateLinkTokenParams].
         *
    ...
    /** A builder for [PlaidCreateLinkTokenParams]. */
    class Builder internal constructor() {
        ...
        internal fun from(plaidCreateLinkTokenParams: PlaidCreateLinkTokenParams) = apply {
            body = plaidCreateLinkTokenParams.body.toBuilder()
            additionalHeaders = plaidCreateLinkTokenParams.additionalHeaders.toBuilder()
            additionalQueryParams = plaidCreateLinkTokenParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [PlaidCreateLinkTokenParams].
         *
         ...
         */
        fun build(): PlaidCreateLinkTokenParams =
    ...
    private constructor(
        ...
        class Builder internal constructor() {
             ...
             */
            fun build(): Body =
                Body(checkRequired("customerId", customerId), additionalProperties.toMutableMap())
        }
        ...
        override fun toString() =
            "Body{customerId=$customerId, additionalProperties=$additionalProperties}"
    }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is PlaidCreateLinkTokenParams &&
            body == other.body &&
    ...
    override fun toString() =
        "PlaidCreateLinkTokenParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
