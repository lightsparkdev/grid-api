package com.grid.api.core.http

import com.grid.api.core.DefaultSleeper
import com.grid.api.core.RequestOptions
import com.grid.api.core.Sleeper
import com.grid.api.core.checkRequired
import com.grid.api.errors.GridIoException
import com.grid.api.errors.GridRetryableException
...
private constructor(
    ...
    private fun shouldRetry(throwable: Throwable): Boolean =
        ...
        throwable is IOException ||
            throwable is GridIoException ||
            throwable is GridRetryableException
