...
import { formatUsdCents, type CardControls, type SpendLimits } from '@/apps/shared/wallet';
...
export function CardDetailsSheet({ card }: { card: CardControls }) {
  ...
  const name = customizable ? design.programName.trim() || 'Your brand' : 'Aurora';
  return (
    <SheetShell
      open={open}
    ...
    >
      <div className={styles.walletBody}>
        ...
        <div className={styles.passStack} aria-hidden>
          ...
          >
            <DebitCard interactive={false} issued />
          </motion.div>
        </div>
